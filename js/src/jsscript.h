...
class ScriptSource
{
  ...
  public:
    ...
    [[nodiscard]] bool appendSubstring(JSContext* cx, js::StringBuffer& buf, size_t start, size_t stop);
    ...
    [[nodiscard]] bool setSource(JSContext* cx,
...
#  endif
  ...
  public:
    ...
    [[nodiscard]] bool appendSourceDataForToString(JSContext* cx, js::StringBuffer& buf);
...
#undef OFF
    ...
    JSObject* getObject(size_t index) {
        ...
        MOZ_RELEASE_ASSERT(index < arr->length, "Script object index out of bounds");
