...
class IonGetPropertyIC : public IonIC
{
  ...
  public:
    ...
    static [[nodiscard]] bool update(JSContext* cx, HandleScript outerScript, IonGetPropertyIC* ic,
...
class IonGetPropSuperIC : public IonIC
{
  ...
  public:
    ...
    static [[nodiscard]] bool update(JSContext* cx, HandleScript outerScript, IonGetPropSuperIC* ic,
...
static [[nodiscard]] bool update(JSContext* cx, HandleScript outerScript, IonSetPropertyIC* ic,
...
class IonInIC : public IonIC
{
  ...
  public:
    ...
    static [[nodiscard]] bool update(JSContext* cx, HandleScript outerScript, IonInIC* ic,
