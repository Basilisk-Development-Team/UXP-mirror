...
class NativeObject : public ShapedObject
{
  ...
  protected:
    ...
    [[nodiscard]] static bool toDictionaryMode(JSContext* cx, HandleNativeObject obj);
  ...
  public:
    [[nodiscard]] static bool generateOwnShape(JSContext* cx, HandleNativeObject obj,
                                              Shape* newShape = nullptr)
    {
        return replaceWithNewEquivalentShape(cx, obj, obj->lastProperty(), newShape);
    }

    [[nodiscard]] static bool shadowingShapeChange(JSContext* cx, HandleNativeObject obj,
                                                  const Shape& shape);
  ...
  public:
    ...
    getDenseOrTypedArrayElement(JSContext* cx, uint32_t idx,
